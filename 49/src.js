...
666a^16---14---15---16---14---15---16---1417161516---15---14---15---12---13---14-------,655b^111211121213121313141314151415-,644b^16-------15--1716151214,633c^1617161511-1617161511-16171615,
622c^13-12-11-14-1413121115-1514131216-1615-16-14-15-16-,c^32^33^42^43b^34^35^44^45a^36^37^46^4731^37^41^47,
11-141516---,13-141516---,12-151617-1214,11---14-1516,13-141516---,12-151617---,12-151617-1214,----37^47---31^32^33,
45^46^47^12^14^1612^14^1612^14^16^a-,34^35^36^13^15^1713^15^1713^15^17-,41^42^43^11^13^1511^13^1511^13^1511^13^15,32^33^34^12^14^16-41^42^43^13^15^1745^46^47^13^15^17,
41^42^43^12^14^1612^14^1612^14^16^a-,33^34^35^13^15^1713^15^1713^15^17-,45^46^47^11^13^1511^13^1511^13^1511^13^15,35^36^37^511a^577a41^42^43^523a^556a,a^31^32^33^45^46^47
`,
...
score:
------1111,
141711-16-12-,15131414,13151216,11-17-11-1717,17111612,15131414,13151216,11-17-11-17611a^633a^655a^677a,
a^17111612,15131414,13151216,11-17-11-1717,17111612,15131414,13151216,566a--522a--544a--644a--622a^17-666a^14-,
a^171711-16-12-,15131414,13151216,11-17-11-1717,17111612,15131414,13151216,11-17-11-17611a^633a^655a^677a,
a^17111612,15131414,13151216,11-17-11-1717,17111612,15131414,13151216,566a--522a--544a--644a--622a-666a-,
a
`
, 
};
    ...
    hazwardList.forEach((x,y)=>{
        if (["1","2","3","4"].indexOf(x[0]) > -1) {
            ...
            if (x[5] == 2) {
                ...
                switch (x[0]) {
                    case "5": ctx.fillRect(-450+x[1]*100,canvas.height/2/-ratio,(x[2]-x[1])*100+100,200*easing(beat+4-x[4],4,4)); break;
                    case "6": ctx.fillRect(canvas.width/2/-ratio,-450+x[1]*100,200*easing(beat+4-x[4],4,4),(x[2]-x[1])*100+100); break;
                }
            }
        }
    });
