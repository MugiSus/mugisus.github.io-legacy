...
var stars = [], started = new Date().getTime(), time = 0, speed = 10, starDen = 0;
while (stars.length < 100) stars.push([-900 + Math.random() * 1800, -1600 + Math.random() * 3200, 1 + Math.random() * 19, 0.5 + Math.random() * 0.5]);
...
function game(){
    ...
    else if (time % 20000 < 20000) speed-=1;
    backGround();
